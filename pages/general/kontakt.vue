  ...
  <div class="bg-base-100 text-base-content">
    ...
    <div class="py-16 container mx-auto px-4 max-w-4xl">
      <div class="prose prose-lg max-w-none">
        ...
        <div class="mb-16">
          <h2 class="font-display text-3xl font-bold mb-8 text-center">{{ t('form.title') }}</h2>
        ...
        <div class="mb-16">
          <h2 class="font-display text-3xl font-bold mb-8 text-center">{{ t('alternatives.title') }}</h2>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="card bg-base-200 p-6 rounded-2xl border border-base-300">
              <h3 class="font-display text-xl font-bold mb-4">{{ t('alternatives.videocall.title') }}</h3>
              <p class="mb-4">{{ t('alternatives.videocall.description') }}</p>
              <a href="https://meet.brevo.com/steffenstein" target="_blank" class="text-pink-500 hover:text-pink-600 font-bold">{{ t('alternatives.videocall.link') }} →</a>
            </div>
          </div>
        </div>
        ...
        <div class="card bg-base-200 p-6 rounded-2xl border border-base-300 mb-16">
          <h2 class="font-display text-2xl font-bold mb-4">{{ t('response.title') }}</h2>
...
const handleSubmit = async () => {
  try {
    ...
    if (response.success) {
      ...
      errorMessage.value = response.message || 'Ein Fehler ist aufgetreten. Bitte versuchen Sie es später erneut.'
    }
  } catch (error) {
